...
def screen(sensor_input):
    ...
    draw.text((x, top+16),    "Sensor1: Temp "+str(sensor_input['temp_pin%s'%(str(PIN[0]))])+" "+sensor_input['temp_scale']+" Humidity "+str(sensor_input['humidity_pin%s'%(str(PIN[0]))]), font=font, fill=255)
