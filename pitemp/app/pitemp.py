...
class PiTemp():
    ...
    def screen(self):
        ...
        while True:
            ...
            draw.text((x, top+16),    "S1: "+str(sensor_input['temp_pin%s'%(str(PIN[0]))])+" "+sensor_input['temp_scale']+"Humidity "+str(sensor_input['humidity_pin%s'%(str(PIN[0]))]), font=font, fill=255)
...
if __name__=='__main__':
    ...
    pt = PiTemp()
    schedule.every(settings.INTERVAL).seconds.do(pt.temp_sensor())
